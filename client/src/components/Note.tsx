  ...
  const NoteComponent = ({
    ...
    return (
      <Container
        ...
        } py-0 flex justify-between items-center overflow-hidden group duration-200`}
      >
        <div className="flex gap-3 py-2">
          ...
          <div className="flex-1">
            <p className={`py-1 whitespace-normal break-words ${characterNote ? "text-sm" : "text-base"}`}>
              {content}
            </p>
