...
export const getMe = async () => {
  try {
    const res = await fetch(
      "https://book-nest-api-silk.vercel.app/api/auth/getme",
      {
        method: "GET",
        credentials: "include",
        headers: {
...
export const submitLogIn = async (formData) => {
  ...
  try {
    const res = await fetch(
      "https://book-nest-kt6irnr4i-henriquedummers-projects.vercel.app/api/auth/login",
      {
        method: "POST",
        credentials: "include",
        headers: {
...
export const logout = async () => {
  try {
    const res = await fetch(
      "https://book-nest-oqjzxysca-henriquedummers-projects.vercel.app/api/auth/logout",
      {
        method: "POST",
        credentials: "include",
        headers: {
...
export const getBooksByStatus = async (status) => {
  try {
    const res = await fetch(
      "http://localhost:8080/api/books/status/" + status,
      {
        method: "GET",
        credentials: "include",
        headers: {
